...
//template <size_t N , typename T> Array <N , T>::Array (const Array <N , T> & a)
//{
...
//template <size_t N , typename T> T * Array <N , T>::getData () const
//{
//    return m_data ;
//}

//template <size_t N , typename T> void Array <N , T>::resize (int size)
//{
